...
public class demo1 {
    ...
    public void run() {
        ...
        kwic.input("C:\\Users\\26384\\Documents\\javacode\\tixijiegou\\src\\input.txt");
        kwic.shift();
        kwic.alphabetizer();
        kwic.output("C:\\Users\\26384\\Documents\\javacode\\tixijiegou\\src\\output.txt");
        ...
        System.out.println("主程序-子程序软件体系结构是一种分层的软件设计方法，它将软件分解为一个主程序和多个子程序。\n这种结构有助于组织和管理复杂的软件系统，提高代码的可读性、可维护性和可扩展性。");
    }
